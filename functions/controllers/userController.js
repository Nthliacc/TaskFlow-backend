...
var createUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, email, password, existingUser, hashedPassword, newUser, token, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                if (existingUser) {
                    return [2 /*return*/, res.status(400).json({ error: 'E-mail já está sendo usado' })];
                }
            ...
            case 4:
                newUser = _b.sent();
                token = jsonwebtoken_1.default.sign({ userId: newUser.id, email: newUser.email }, JWT_SECRET, {
